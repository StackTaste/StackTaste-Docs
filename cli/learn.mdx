...
```bash
bunx stacktaste learn "Prefer tabs" --body "Indent with tabs, not spaces."
bunx stacktaste learn --kind policy "No lodash"
```
...
```bash
bunx stacktaste review
bunx stacktaste review accept <id-or-title>
bunx stacktaste review reject <id-or-title>
```
...
```bash
bunx stacktaste check
bunx stacktaste check apps/web/src/lib/foo.ts
```
